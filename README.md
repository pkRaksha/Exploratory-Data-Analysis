...
### Objective : 
This project aims to analyze the pattern in hotel booking, and cancelations made to draw useful insights to impact business in a positive way.
### Project Summary:
...
- Null values in column country were replaced by 'Not provied'.
- Null values in column children were replaced by the 0 of the column.


#### Creating new columns
- Created new column length_of_stay by adding stays_in_weekend_nights+stays_in_week_nights.
- Created new column total_occupant by adding adults+children+babies.
- Created new column date_arrived by adding arrival_date_year + arrival_date_month
